	...
	const suggestionBoxes: SuggestionBox[] = [
		{
			...
			public_link: 'localhost:5173/pub/94819', // Generated link
			suggestions: [
				{
					id: '1',
		...
		},
		{
			...
			public_link: 'localhost:5173/pub/0394819', // Generated link
			suggestions: [
				{
					id: '1',
					name: 'Suggestion Title 1',
...
<!-- Summary of each suggestion box, 
name of box, details (optional), created_at -->
	...
	<Card.Root class="bg-muted" id={`suggestion-${suggestionBox.id}`}>
		...
		<Card.Content class="flex justify-between">
			<div class="space-y-2 text-sm">
				<p>{suggestionBox.suggestions.length} suggestions</p>
				...
				<div class="flex gap-2">
					<Link class="size-4" />
					<a
						href={suggestionBox.public_link}
						class="text-sm font-thin text-blue-400 hover:underline"
					>
						{suggestionBox.public_link}
					</a>
				</div>
			</div>
			<Button
